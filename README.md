...
The Trip Management API owns trips, stops, deliveries, route plans, toll estimation, and public tracking links. It plans routes through OpenRouteService, detects stop arrivals and route deviations from telemetry positions, and drives the trip lifecycle from `Created` through to a terminal status.
