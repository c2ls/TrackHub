...
/// <c>trip_client</c> identity (TripManagement has no local BackgroundJobRun table). Both trip
/// jobs are on-work-only recorders (SVD-11), so a row is written only when work happened.
/// </summary>
