...
public sealed class TransporterConfiguration : IEntityTypeConfiguration<Transporter>
{
    ...
    {
        // Manager-owned table: read-only here, never part of this repo migrations.
        builder.ToTable(name: TableMetadata.Transporter, schema: SchemaMetadata.Application, t => t.ExcludeFromMigrations());
