...
show_config() {
    ...
    echo "  DB_CONNECTION_TELEMETRY: ${DB_CONNECTION_TELEMETRY:+***configured***}"
    echo "  DB_CONNECTION_LOGGING: ${DB_CONNECTION_LOGGING:+***configured***}"
    echo ""
...
REACT_APP_TRIPMANAGEMENT_ENDPOINT=${REACT_APP_TRIPMANAGEMENT_ENDPOINT}
REACT_APP_TELEMETRY_ENDPOINT=${REACT_APP_TELEMETRY_ENDPOINT}
