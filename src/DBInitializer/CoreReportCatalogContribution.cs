...
/// rather than growing this array.
/// </summary>
internal sealed class CoreReportCatalogContribution : IReportCatalogContribution
{
    public IReadOnlyList<(string Code, string Description, string Category, string? RequiredFeatureKey, bool ManagerOnly, bool SupportsPdf, int SortOrder)> Reports { get; } =
    [
        // Operations (global + geofencing-gated)
        (Common.Domain.Constants.Reports.LiveReport, "Live Report", "Operations", null, false, false, 10),
        (Common.Domain.Constants.Reports.PositionRecord, "Position Record", "Operations", null, false, false, 20),
        ...
        (Common.Domain.Constants.Reports.GeofenceEvents, "Geofence Events", "Operations", FeatureKeys.Geofencing, false, false, 40),

        // GPS integration
        (Common.Domain.Constants.Reports.GpsProviderHealthSummary, "GPS Provider Health Summary", "Gps", FeatureKeys.GpsIntegration, true, true, 10),
        (Common.Domain.Constants.Reports.GpsProviderSyncHistory, "GPS Provider Sync History", "Gps", FeatureKeys.GpsIntegration, false, false, 20),
        (Common.Domain.Constants.Reports.GpsSyncStatistics, "GPS Sync Statistics", "Gps", FeatureKeys.GpsIntegration, false, false, 30),
        (Common.Domain.Constants.Reports.GpsSynchronizedDeviceInventory, "GPS Synchronized Device Inventory", "Gps", FeatureKeys.GpsIntegration, false, false, 40),
        (Common.Domain.Constants.Reports.GpsRecentlyAddedDevices, "GPS Recently Added Devices", "Gps", FeatureKeys.GpsIntegration, false, false, 50),
        ...
        (Common.Domain.Constants.Reports.GpsIgnoredDevices, "GPS Ignored Devices", "Gps", FeatureKeys.GpsIntegration, false, false, 70),
        (Common.Domain.Constants.Reports.GpsAssignmentHistory, "GPS Assignment History", "Gps", FeatureKeys.GpsIntegration, false, false, 80),
        ...
        (Common.Domain.Constants.Reports.GpsPositionHistory, "GPS Position History", "Gps", FeatureKeys.GpsPositionHistory, false, false, 100),
